	...
	public static class FriendsMapper
		...
		public static class FriendsReducer
			...
			public void reduce(Text key, Iterable<Text> values, Context context)
				throws IOException, InterruptedException{
				//Prepare a 2-String-Array to hold the values, i.e. the friends list of
				...
				//Calculate the intersection of these lists and write the result in the form(UserAUserB, MutualFriends).
